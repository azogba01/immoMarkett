...
<body>
        ...
        <div class="row">
          <div class="col-md-12 mb-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-lg form-control-a"  name="query" placeholder="Keyword">
          </div>
          </div>
          ...
          <div class="col-md-6 mb-2">
            <div class="form-group mt-3">
              ...
              <select class="form-control form-select form-control-a"   name="query" placeholder="Keyword" id="Type">
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.html">Imo<span class="color-b">Market</span></a>
                           ...
                           {{-- @if (Route::has('login'))
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item btn btn-success {{ request()->is('/register') ? 'active' : '' }}">
                                     <a class="nav-link " href="{{ route('login') }}"> Publier ?</a>
                                </li>
                            @endif
                        @else
